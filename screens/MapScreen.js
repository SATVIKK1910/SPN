...
//                           <FontAwesome name="cloudy" size={15} color="#fff" style={styles.iconn} />
//
//                       </Text>
//                       <Text style={styles.routeDetailText}>
...
//
//                   >
//                       <FontAwesome name="person-circle" size={30} color="#fff" />
...
//                             }}
//                         >
//                             <FontAwesome name="close-circle-outline" size={30} color="black" />
//                         </TouchableOpacity>
//                     </View>
//                 </View>
//             )}
          ...
          try {
              ...
              if (response.data.paths?.length > 0) {
                  const routes = response.data.paths.slice(0, 3).map((route, index) => ({
                      coords: decodePolyline(route.points),
                      distance: (route.distance / 1000).toFixed(2), // Convert to km
                      crimeScore: (Math.floor(Math.random() * 10) + 1) + (index * 10), // Simulated data
                      proximityScore: Math.floor(Math.random() * 10) + 1, // Simulated data
                      label: `Route ${index + 1}`,
                  }));
              ...
              {selectedRouteDetails && (
                  <View style={styles.routeDetailsContainer}>
                    <View style={styles.rr}>
                      ...
                      <Text style={styles.routeDetailText}>
                          Crime Score: {selectedRouteDetails.crimeScore || 'N/A'} / 10
                          <FontAwesome name="sun-o" size={15} color="#fff" style={styles.iconn} />
